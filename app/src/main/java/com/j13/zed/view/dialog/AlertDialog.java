...
public class AlertDialog extends Dialog implements DialogInterface {
    ...
    protected AlertDialog(Context context, int theme) {
        ...
        mAlert = new DialogController(getContext(), this, getWindow());
    }
    ...
    protected AlertDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        ...
        mAlert = new DialogController(context, this, getWindow());
    }

    static int resolveDialogTheme(Context context, int resid) {
        TypedValue outValue = new TypedValue();
        context.getTheme().resolveAttribute(android.R.attr.alertDialogTheme,
                outValue, true);
    ...
    public void setWindowMatchBottom() {
        mAlert.setWindowMatchBottom();
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, int theme) {
            P = new DialogController.AlertParams(new ContextThemeWrapper(
