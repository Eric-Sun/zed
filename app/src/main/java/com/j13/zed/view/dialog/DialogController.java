...
public class DialogController {
    ...
    public DialogController(Context context, DialogInterface di, Window window) {
        ...
        mAlertDialogLayout = a.getResourceId(R.styleable.AlertDialog_android_layout,
    ...
    public void setWindowMatchBottom() {
        mWindow.setGravity(android.view.Gravity.BOTTOM);
    ...
    private void setupView() {
        ...
        if (hasTitle) {
            if (mMessage != null || mView != null || mListView != null) {
                mTitleDivider = mWindow.findViewById(R.id.titleDivider);
            }
    ...
    private void setupContent(LinearLayout contentPanel) {
        ...
        if (mMessage != null) {
            ...
            if (mListView != null) {
                ...
                //show from bottom and fill the screen
